  ...
  return (
    <header className="sticky top-0 z-30 w-full bg-navyCard/90 backdrop-blur-md border-b border-goldPrimary/15 px-4 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        <div className="bg-darkBg/80 px-3 py-1 rounded-full border border-goldPrimary/20 text-xs font-semibold text-goldPrimary">
          ৳{parseFloat(balance).toLocaleString('en-US', { minimumFractionDigits: 2 })}
        </div>
        
        <Link href="/support" className="relative p-2 rounded-xl bg-darkBg/60 border border-goldPrimary/20 text-gray-300 hover:text-goldPrimary transition-colors">
