...
export default function QuickActions() {
  const actions = [
    ...
    { label: 'Machines', icon: Cpu, path: '/machines', color: 'text-goldPrimary border-goldPrimary/30' },
      ...
      {actions.map((item) => {
        ...
        return (
          <Link key={item.label} href={item.path}>
            <div className="bg-navyCard/70 border border-goldPrimary/15 rounded-xl p-3 flex flex-col items-center justify-center gap-1.5 hover:border-goldPrimary/40 transition-all active:scale-95">
