...
export default function WalletCard({ stats }) {
  ...
  return (
    <div className="bg-gradient-to-br from-navyCard to-darkBg border border-amber-500/50/30 rounded-2xl p-5 shadow-2xl relative overflow-hidden">
      ...
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <h2 className="text-3xl font-extrabold text-amber-400 tracking-tight mt-1">
            ৳{parseFloat(balance).toLocaleString('en-US', { minimumFractionDigits: 2 })}
          </h2>
        </div>
        <div className="w-10 h-10 rounded-xl bg-amber-500/10 border border-amber-500/50/30 flex items-center justify-center text-amber-400 shadow-inner">
          <Wallet className="w-5 h-5" />
        </div>
      </div>

      {/* Today Mining Badge */}
      <div className="bg-darkBg/80 border border-amber-500/50/20 rounded-xl p-2.5 mb-4 flex items-center justify-between">
      ...
      {/* Sub Stats Grid */}
      <div className="grid grid-cols-3 gap-2 pt-3 border-t border-amber-500/50/15 text-center">
        <div>
        ...
        <div className="border-x border-amber-500/50/15">
