  ...
  return (
    <MobileWrapper>
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center bg-gradient-to-b from-darkBg via-navyCard to-darkBg relative overflow-hidden">
        ...
        <div className="absolute w-64 h-64 bg-amber-500/10 rounded-full blur-3xl pointer-events-none animate-pulse" />

        {/* Animated Mining Logo */}
        <div className="relative mb-6">
          <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-goldPrimary to-goldHover border-2 border-amber-500/50/50 flex items-center justify-center shadow-2xl shadow-goldPrimary/30 animate-bounce">
        ...
        <div className="w-full max-w-[260px] space-y-2">
          <div className="w-full h-2 bg-darkBg rounded-full border border-amber-500/50/20 overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-goldPrimary to-activeGreen transition-all duration-150 ease-out"
              style={{ width: `${progress}%` }}
            />
          </div>
          <span className="text-[11px] text-amber-400 font-semibold tracking-widest">
            LOADING {progress}%
          </span>
        </div>
      </div>
